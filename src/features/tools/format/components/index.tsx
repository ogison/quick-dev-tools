                ...
                <div className="grid gap-6 lg:grid-cols-2">
                                ...
                                <DropdownMenuContent align="start" className="w-48">
                                  {Object.entries(SAMPLE_DATA).map(([key, sample]) => (
                                    <DropdownMenuItem
                                      key={key}
                                      onClick={() =>
                                        handleLoadSample(key as keyof typeof SAMPLE_DATA)
                                      }
                  ...
                  <div className="space-y-3">
                          ...
                          <div>
                            {output && !error ? (
                              <div
                                className={`mb-4 h-[450px] w-full rounded-lg border p-0 font-mono text-sm`}
                              >
                                <SyntaxHighlighter
                                  language={
                                    formatType === 'auto' ? detectedType || 'text' : formatType
                                  }
                                  style={theme === 'dark' ? materialLight : materialDark}
                                  customStyle={{
                                    margin: 0,
                                    padding: '1rem',
                                    height: '450px',
                                  ...
                                  wrapLongLines
                                  showLineNumbers
                                  aria-label="Formatted output with syntax highlighting"
                                >
                                  {output}
                                </SyntaxHighlighter>
                              </div>
                          ...
                          {isBasicFormatUsed && !error && output && (
                            <div className="mt-2 text-sm text-yellow-600 dark:text-yellow-400">
                              ⚠️
                              フォーマットタイプを検出できませんでしたが、基本的な整形を行いました
                            </div>
                          )}
                  </div>
                </div>
                          ...
                          <CardContent className="space-y-6 p-6">
                            ...
                            <div className="border-t border-gray-200 pt-6 dark:border-gray-700">
                              ...
                              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <li>
                                  • JSON、YAML、SQL、XML、CSS、HTMLを自動検出してフォーマットします
                                </li>
                                <li>
                                  • サンプルデータを使ってフォーマット機能をお試しいただけます
                                </li>
                                <li>
                                ...
                                <li>
                                  • フォーマット後の結果はコピーまたはファイルとして保存できます
                                </li>
                              </ul>
                            </div>
