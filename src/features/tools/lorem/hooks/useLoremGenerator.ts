...
const LATIN_WORDS = [
  ...
  'accusantium', 'et', 'iusto', 'odio', 'dignissimos', 'ducimus', 'blanditiis',
...
const JAPANESE_WORDS = [
  ...
  '朝', '昼', '夜', '月', '星', '太陽', '森', '野', '谷', '峠', '道', '橋',
  '家', '町', '村', '人', '子', '母', '父', '友', '先生', '学校', '本', '机',
  '窓', '扉', '庭', '池', '井戸', '畑', '田', '麦', '米', '茶', '酒', '食'
];

// Programming-style words
const PROGRAMMING_WORDS = [
  'function', 'variable', 'array', 'object', 'string', 'number', 'boolean',
  'const', 'let', 'var', 'if', 'else', 'for', 'while', 'return', 'import',
  'export', 'class', 'interface', 'type', 'async', 'await', 'promise',
  'callback', 'handler', 'component', 'props', 'state', 'event', 'data',
  'config', 'utils', 'helper', 'service', 'api', 'endpoint', 'request',
  'response', 'error', 'success', 'loading', 'pending', 'complete'
];
