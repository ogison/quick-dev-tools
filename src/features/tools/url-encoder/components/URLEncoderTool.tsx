...
const SAMPLE_DATA = {
  ...
  japanese: {
    name: '日本語パラメータ',
    value:
      'https://shop.example.com/products?category=電子機器&name=ノートパソコン&price=100,000円',
  },
  complex: {
    name: '複雑なクエリ',
    value:
      'https://api.example.com/v1/users?name=田中太郎&email=tanaka@example.com&tags=開発者,フロントエンド,React',
  },
  path: {
    name: 'パス含む',
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
                    ...
                    <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                      <li>
                        • <strong>Ctrl + Enter</strong>: エンコード/デコード実行
                      </li>
                      <li>
                        • <strong>Ctrl + Z</strong>: 入力を元に戻す
                      </li>
